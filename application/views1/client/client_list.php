        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                ...
                <?php if($role == '1' || $role == '2'){?>
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>importClient"><i class="fa fa-plus"></i> Import Clients</a>
                    <?php }?>
                </div>
            </div>
        </div>
        	...
        	<form action="<?php echo base_url() ?>client" method="POST" id="">
                ...
                <div class="col-md-1">
                	<select name="documentation" class="form-control" id="documentation">
                        ...
                        <option value="yes" <?php echo ($documentation == 'yes')?'selected="selected"':''?>>Yes</option>
                        <option value="no" <?php echo ($documentation == 'no')?'selected="selected"':''?>>No</option>
                    </select>
                </div>
                <div class="col-md-1">
