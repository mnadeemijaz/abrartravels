...
<div class="content-wrapper" style="padding:5px">
    ...
    <section class="content-header">
      ...
      <?php if($this->session->flashdata('error')){?>
      	<label class="alert alert-success"><?php echo $this->session->flashdata('error')?></label>
      <?php }?>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <div class="row">
                	<div class="col-md-3 colmd">
                    	<div class="form-group">
                        	<div class="col-md-6 colmd">
                        	<label>Sector</label>
                            <select name="ret_sector" id="ret_sector" class="form-control" onchange="changeCity()">
                                <option value="JED">JED</option>
                                <option value="MED">MED</option>
                            </select> - </div>
                            <div class="col-md-6 colmd">
            ...
            <div class="panel panel-primary">
            	<div class="panel-heading">
                	Mautamer's Information <?php echo $this->session->userdata('client_id');?>
                </div>
                <div class="panel-body">
                ...
                <div class="panel panel-primary">
                 ...
                 <div class="form-group">
                    <div class="row" style="padding-left:20px; padding-right:20px">
                    	<div class="col-md-2 colmd">
                        	<div class="form-group">
                            	<select name="city_name[]" id="city_name_1" class="form-control" onchange="return get_hotel_by_city(this)">
                        ...
                        <div class="col-md-1 colmd">
                        	<div class="form-group">                            	
                            	<input type="text" name="city_night[]" id="city_night_1" onchange="city_night_cal(this)" class="form-control night_total" value="0">
                        	</div>
                        </div>
                        <div class="col-md-2 colmd">
                        	<div class="form-group">                            	
                          		<input type="text" readonly="readonly" style="background:transparent; " name="check_in[]" id="check_in_1" class="form-control " onchange="nights1()">
                        	</div>
                        </div>
                        <div class="col-md-2 colmd">
                        	<div class="form-group">                            	
                            	<input type="text" readonly="readonly" style="background:transparent; " name="check_out[]" id="check_out_1" class="form-control " onchange="nights1()">
                        	</div>
                        </div>
                        <div class="col-md-2 colmd">
                        	<div class="form-group">
                            	<select name="hotel[]" id="hotel_1" class="form-control">
                                    <option value="">select</option>
                        ...
                        <div class="col-md-2 colmd">
                        	<div class="form-group">
                            	<?php 
									...
									?>
                                        <select name="room_type[]" id="room_type_1" class="form-control" onchange="return get_hotel_by_city(this)">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                    	...
                    	<div class="row">
                        	<div class="form-group">
                                <div class="col-md-5">
                                <label style="margin-top:10px">Ziarat</label><br>
                                <div style="border:1px solid #D0CEC4; margin-top:4px; padding:24px">
                                    <?php foreach($ziarat as $zia){ 
										if($zia->id == 1){
									?>
                                        <input type="checkbox" id="nziarat" name="nziarat" <?php echo ($zia->id == 1)?'checked="checked"':''?> value="<?php echo $zia->id?>"><?php echo $zia->name; }
										else {?>
                                        <input type="checkbox" class="ziarat_id" id="ziarat_id" name="ziarat_id[]" <?php echo ($zia->id == 1)?'checked="checked"':''?> value="<?php echo $zia->id?>"><?php echo $zia->name; }?>
                                    <?php }?>
                                </div>
                                </div>
                            </div>
                    	...
                    	<div class="row">
                        	<div class="form-group">
                                ...
                                <div style="border:1px solid #D0CEC4; margin-top:4px; padding:24px">
                                    <input type="radio" name="contact" id="package_with_hotel" value="package_with_hotel" checked> Package with Hotel
                                    <input type="radio" name="contact" id="only_transport" value="only_transport"> Only Transport
								</div>
                            </div>
                        </div>
                    </div>
