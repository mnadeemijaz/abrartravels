                ...
                <div class="panel panel-primary">
                    ...
                    <div class="row" style="padding-left:30px">
                    	<?php foreach($vehicles as $veh){?>
                        	...
                        	<input <?php echo ($voucherInfo->vehicle_id == $veh->id)?'checked="checked"':''?> type="radio" onclick="return get_trip(this.value,'')" name="vehicle" id="vehicle" value="<?php echo $veh->id?>"><?php echo $veh->name?>
                            </span>
                            </div>
                        <?php }?>
                     </div>
