...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-building"></i> Bank Management
                ...
                <div class="box box-primary">
					...
					<?php }?>
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo (isset($bankInfo->name))?$bankInfo->name:''?>" id="name" name="name" maxlength="128">
                                    </div>                                    
                                </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url()?>bank" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
