<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-building"></i> Departure Report
        <small>View</small>
      </h1>
    </section>
    <section class="content">        
        <div class="row">
        	<form action="<?php echo base_url() ?>departure_report" method="POST" id="">
            <div class="col-md-2">
            	Shirka:
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>departure_report" method="POST" id="searchList">
                    ...
                    <a href='<?php echo base_url() ?>departure_report_excel'><i class="fa fa-file-excel-o "> </i>  </a>
                        <a href='<?php echo base_url() ?>departure_report_word'> <i class="fa fa-file-word-o "> </i> </a>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive no-padding" style="height:400px">
                  <table class="table table-bordered table-striped dataTable table-hover vtable">
                    ...
                    <td><a class="label label-success" href="<?php echo base_url()?>voucherView/<?php echo $record->id?>">view</a></td>                      
                      ...
                      <td><?php echo $record->ret_time ?></td>
                      <td><?php echo $record->flight_name.' '.$record->ret_flight_no ?></td>
                      <td><?php echo ($record->ret_sector == 'JED')? 'Jeddah Airport':'Media Airport' ?></td>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "departure_report/" + value);
